      ...
      <div>
        <Router>
          <Routes>
            ...
            <Route
              exact
              path="/login/buyer" //Path for it to be added too
              element={<BuyerPageFramework component={<Buyer />} />}
            />
            <Route
              exact
              path="/login/seller" //Path for it to be added too
              element={<SellerPageFramework component={<Seller />} />}
            />
            <Route
              exact
              path="/login/designer" //Path for it to be added too
            ...
            <Route
              ...
              element={
                <Template
                  children={<LoginScreenBase children={<LoginForm />} />}
                />
              }
            />
            <Route
              ...
              element={
                <Template
                  children={
                    <LoginScreenBase children={<CreateAccountForm />} />
                  }
                />
              }
            />
            <Route
              exact
              path="/SignUp/SellerSignUp"
              element={
                <Template
                  children={<LoginScreenBase children={<CreateSellerForm />} />}
                />
              }
            />
            <Route
              exact
              path="/SignUp/BuyerSignUp"
              element={
                <Template
                  children={<LoginScreenBase children={<CreateBuyerForm />} />}
                />
              }
            />
            ...
            {/**must also include small navbar routing like location editor and message inbox */}
            <Route
              path="/chats" //Path for it to be added too
              element={<SellerPageFramework component={<Chatpage />} />}
            />
          </Routes>
        </Router>
      </div>
